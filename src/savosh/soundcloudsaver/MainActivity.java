...
public class MainActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabHost.addTab(mTabHost.newTabSpec(SearchFragment.TAG).setIndicator("Search"), SearchFragment.class, null);
        mTabHost.addTab(mTabHost.newTabSpec(SaverFragment.TAG).setIndicator("Save"), SaverFragment.class, null);
